...
const SingleLatestCard = ({ item }) => {
    return (
        <div className="w-[95%] md:h-140 h-115 p-6 bg-cover bg-no-repeat bg-center relative rounded-[20px] shadow hover:shadow-[0px_4px_16px_rgba(17,17,26,0.1),0px_8px_24px_rgba(17,17,26,0.1),0px_16px_56px_rgba(17,17,26,0.1)] duration-300 hover:scale-[1.02] my-2" style={{ backgroundImage: `url(${item.image})` }}>
