        ...
        <>
            ...
            <section id='Complete'>
                <div className="container">
                    <div className="flex items-center justify-center overflow-hidden md:mt-0 mt-2">
                        ...
                        <div className="max-w-xl w-full text-center z-10">
                            ...
                            <div className="space-y-4 mb-10 animate-fade-up">
                                ...
                                <div className="text-text-secondary md:text-lg text-base max-w-md mx-auto leading-relaxed">
                                    Hooray! Your payment was successful and your order <p className="text-accent font-bold">#REX-198861</p> is now being prepared for shipping.
                                </div>
                            </div>
                                ...
                                <div className="flex items-center justify-between mb-8 pb-6 border-b border-border/50">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-sm font-black text-text-primary">REX-198861</p>
                                        </div>
                                    </div>
                            ...
                            <div className="mt-8 flex items-center justify-center gap-6 animate-fade-in delay-700">
                                <Link href="/" className="text-sm font-bold text-text-secondary hover:text-accent transition-colors flex items-center gap-2">
                                    <Home size={16} />
                                    Back to Home
                                </Link>
