        ...
        <div className="lg:col-span-1">
            <div className="sticky top-24">
                <div className='p-8 rounded-2xl border border-border '>
                    ...
                    <Link href={to || "/"} className="w-full py-4 bg-accent text-white font-bold rounded-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 shadow-lg shadow-accent/20">
