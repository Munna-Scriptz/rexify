                ...
                <div className="w-full max-w-md flex flex-col items-center animate-slide-in">
                    {isVerified ? (
                        <div className="w-full flex flex-col items-center text-center">
                            <div className="mb-8 p-4 bg-green-100 rounded-2xl">
                                <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-green-500">
                            ...
                            <p className="text-gray-500 text-sm leading-relaxed max-w-sm mx-auto mb-8">
                                Your email has already been verified. You can now access all features of your account.
                            </p>
                            <div className="w-full flex flex-col gap-4">
                                <Button
                                    variant="primary"
                                    onClick={() => router.push('/')}
                                    className="w-full py-4 rounded-2xl bg-coil hover:bg-black border-none text-white shadow-lg"
                                    type="button"
                                >
                                    Go to Home
                                </Button>
                                <Button
                                    ...
                                    className="w-full py-4 rounded-2xl border-2 border-gray-200 hover:border-gray-300 text-coil font-bold bg-transparent"
                                    type="button"
                                >
                                    Go to Profile
                                </Button>
