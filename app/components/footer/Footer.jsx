            ...
            <div className="container relative z-10">
                ...
                <div className="md:hidden flex flex-col items-center gap-8 mb-16">
                    <Link href={'/'} className="hover:scale-105 transition-transform duration-300">
                        <img src="/assets/Logo.png" className='invert w-32' alt="Rexify logo" />
                    </Link>
                ...
                <div className="hidden md:flex mt-15 pt-8 border-t border-gray-100 justify-between items-center">
                    <Link href={'/'} className="hover:opacity-80 transition-opacity">
                        <img src="/assets/Logo.png" className='invert w-36' alt="Rexify logo" />
                    </Link>

                    <div className="text-sm text-gray-400 font-medium">
                        Website developed by <Link href={'https://munna-scriptz.vercel.app/'} target='_blank' className='text-text-primary hover:text-accent transition-colors underline decoration-accent/30 underline-offset-4'>Munna-Scriptz</Link>
                    </div>
                ...
                <div className="md:hidden mt-16 text-center">
                    ...
                    <Link href={'https://munna-scriptz.vercel.app/'} target='_blank' className='text-sm font-bold text-text-primary underline decoration-accent decoration-2 underline-offset-4'>
                        Munna-Scriptz
                    </Link>
                </div>
