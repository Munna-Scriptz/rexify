            ...
            <nav id='navbar' className={`py-3 sticky top-0 duration-300 z-50 group hover:bg-surface ${isNavbarWhite && 'shadow bg-white'}`}>
                <div className="container">
                    <div id='Navbar-Row' className='flex items-center justify-between text-white relative'>
                        ...
                        {/* ------------ Image  */}
                        <Link href={'/'} className='w-24 md:w-32'><Image src={logo} className={`group-hover:invert ${isNavbarWhite && 'invert'}`} alt="Rexify Logo" /></Link>
                        ...
                        <div className={`md:border-l group-hover:border-text-primary/40 ${isNavbarWhite && 'border-text-primary/40'} border-gray-300 md:pl-3 flex items-center gap-1 md:gap-2 `}>
                            ...
                            {/* --------- User  */}
                            <Link href={'/auth'} className={`w-8 h-8 flex items-center justify-center hover:bg-text-muted/20 duration-300 group-hover:text-text-primary ${isNavbarWhite && 'text-text-primary'} text-xl rounded-full cursor-pointer relative`}>
                                <PiUser />
                            </Link>
                        </div>
