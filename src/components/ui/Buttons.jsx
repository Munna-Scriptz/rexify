...
const Button = ({
    ...
    const variants = {
        ...
        delete: "text-text-muted hover:text-red-500 p-1",
        quantity: "w-8 h-8 flex items-center justify-center rounded-md hover:bg-muted text-text-secondary transition-colors",
    };
